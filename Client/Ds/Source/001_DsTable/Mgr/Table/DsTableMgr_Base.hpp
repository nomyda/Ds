...
UnrealTableStruct* DsTableMgr_Base::GetTable(const FName& Tid, const bool bLoad /*= false*/)
{
	if (bLoad)
		ImmediateLoading();
...
template<class UnrealTableStruct>
void DsTableMgr_Base::GetTable(const FName& Tid, TFunction<void(UnrealTableStruct*)> Callback)
{
